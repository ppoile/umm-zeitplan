...
def generate_single_event_data(wettkampf):
    ...
    for day in event_data['wettkampf_data']:
        for candidate in event_data['wettkampf_data'][day]:
            if candidate != wettkampf:
                del single_event_data['wettkampf_data'][day][candidate]
    for day in event_data['wettkampf_start_times']:
        for candidate in event_data['wettkampf_start_times'][day]:
            if wettkampf not in candidate:
                del single_event_data['wettkampf_start_times'][day][candidate]
    for candidate in event_data['teilnehmer_data']:
        if candidate != wettkampf:
            del single_event_data['teilnehmer_data'][candidate]
