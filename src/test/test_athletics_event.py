...
class TestAthleticsEvent(unittest.TestCase):
    ...
    def test_interactive_main_u12m_4k_event(self):
    ...
    def test_interactive_main_u14m_5k_event(self):
    ...
    def test_interactive_main_u14w_5k_event(self):
    ...
    def test_interactive_main_u16_6k_event(self):
    ...
    def test_interactive_main_u16w_5k_event(self):
    ...
    def test_interactive_main_wom_5k_event(self):
    ...
    def test_interactive_main_wom_7K_event(self):
